  ...
  return (
    ...
    >
      <div className="relative flex-1 bg-clay/20 overflow-hidden">
        ...
        {isOutOfStock && (
          <div className="absolute inset-0 flex items-center justify-center bg-bone/40 backdrop-blur-[2px]">
            <span className="bg-deep-olive text-bone px-4 py-2 text-[10px] font-black uppercase tracking-widest">Out of Stock</span>
          </div>
        )}
      ...
      <div className="p-6 border-t border-sage text-deep-olive">
        ...
        <div className="flex items-center justify-between">
           ...
           <span className={`text-[8px] font-bold uppercase tracking-widest ${isOutOfStock ? 'text-red-500' : 'text-sage opacity-50'}`}>
